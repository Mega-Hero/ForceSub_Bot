        ...
        try:
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                     ...
                     [
                           InlineKeyboardButton("💞 Devloveper", url="https://t.me/Develoveper")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Telugu RoBoTs", url="https://t.me/Telugu_robots")
                ],
                [
                    InlineKeyboardButton("Updates Channel", url="https://t.me/MutyalaHarshith"),
                    InlineKeyboardButton("Support Group", url="https://t.me/MHGcHaT")
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/MHGcHaT).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support Group](https://t.me/MHGcHaT).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
